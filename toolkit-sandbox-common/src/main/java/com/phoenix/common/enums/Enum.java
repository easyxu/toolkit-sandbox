 ...
 *
 * @author Michael Zhou
 * @version $Id: Enum.java 579 2004-02-16 05:42:07Z baobao $
 */
@SuppressWarnings("unchecked")
public abstract class Enum extends Number implements IntegralNumber, Comparable, Serializable,
    Convertible {
    ...
    static {
        Convert.getDefaultConvertManager().register(Enum.class, new EnumConverter());
        Convert.getDefaultConvertManager().register(FlagSet.class, new FlagSetConverter());
        Convert.getDefaultConvertManager().registerAlias("enum", Enum.class);
    }
    ...
    private Enum(String name, Object value, boolean withValue) {
        ...
        if (enumType.nameMap.containsKey(name)) {
            throw new IllegalArgumentException(MessageFormat.format(
                    EnumConstants.DUPLICATED_ENUM_NAME, new Object[] { name, enumClass.getName() }));
        }
    ...
    public static FlagSet createFlagSet(Class enumClass) {
        if (!(Flags.class.isAssignableFrom(enumClass))) {
            throw new UnsupportedOperationException(MessageFormat.format(
                    EnumConstants.ENUM_IS_NOT_A_FLAG, new Object[] { enumClass.getName() }));
        }
        ...
        if (enumType.flagSetClassExists && (enumType.flagSetClass == null)) {
            enumType.flagSetClass = findStaticInnerClass(enumClass,
                    EnumConstants.FLAG_SET_INNER_CLASS_NAME, FlagSet.class);
        ...
        throw new UnsupportedOperationException(MessageFormat.format(
                EnumConstants.CREATE_FLAG_SET_IS_UNSUPPORTED, new Object[] { enumClass.getName() }));
    }
    ...
    private static EnumType getEnumType(Class enumClass) {
        ...
        if (!Enum.class.isAssignableFrom(enumClass)) {
            throw new IllegalArgumentException(MessageFormat.format(
                    EnumConstants.CLASS_IS_NOT_ENUM, new Object[] { enumClass.getName() }));
        }
        ...
        if (enumType == null) {
            Method createEnumTypeMethod = findStaticMethod(enumClass,
                    EnumConstants.CREATE_ENUM_TYPE_METHOD_NAME, new Class[0]);
        ...
        if (enumType == null) {
            throw new UnsupportedOperationException(MessageFormat.format(
                    EnumConstants.FAILED_CREATING_ENUM_TYPE, new Object[] { enumClass.getName() }));
        }
    ...
    public Converter getConverter(Class targetType) {
        return new Converter() {
                public Object convert(Object value, ConvertChain chain) {
                    ...
                    return chain.convert(enums.getValue());
                }
            };
    }
     ...
     *
     * @throws java.io.ObjectStreamException 如果反序列化出错
     */
    protected Object readResolve() throws ObjectStreamException {
        Enum enums = Enum.getEnumByName(getClass(), getName());

        if ((enums == null) || !enums.value.equals(value)) {
    ...
    protected abstract static class EnumType {
        ...
        final Object setValue(Object value, boolean flagMode) {
            ...
            if (flagMode && !isPowerOfTwo(value)) {
                throw new IllegalArgumentException(MessageFormat.format(
                        EnumConstants.VALUE_IS_NOT_POWER_OF_TWO, new Object[] { value }));
            }
