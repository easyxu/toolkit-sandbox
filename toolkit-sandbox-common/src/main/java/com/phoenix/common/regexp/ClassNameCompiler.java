 ...
 *
 * @author Michael Zhou
 * @version $Id: ClassNameCompiler.java 509 2004-02-16 05:42:07Z baobao $
 */
public class ClassNameCompiler extends Perl5CompilerWrapper {
    ...
    private static final String REGEX_CLASS_NAME_FULL        = "(" + REGEX_CLASS_NAME_CHAR + "+(?:"
        + REGEX_DOT_NO_DUP + REGEX_CLASS_NAME_CHAR + "*)*(?=" + REGEX_DOT + "|$)|)" + REGEX_DOT
        + "?";
